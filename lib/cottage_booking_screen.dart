...
class CottageBookingScreen extends StatefulWidget {
  final Cottage cottage;
  const CottageBookingScreen({super.key, required this.cottage});

  @override
  State<CottageBookingScreen> createState() => _CottageBookingScreenState();
}

class _CottageBookingScreenState extends State<CottageBookingScreen> {
  ...
  void startPayment() {
    ...
    var options = {
      ...
      'amount': (widget.cottage.price * 100).toInt(),
      'name': 'UrbanStay',
      'description': 'Booking for Cottage ${widget.cottage.cottageNumber}',
      'timeout': 300,
      'prefill': {
  ...
  Future<void> _finishBooking(String status) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Payment Successful! Cottage Booking Confirmed."),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Book Cottage")),
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text("Booking: Cottage ${widget.cottage.cottageNumber}",
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    "Pay ₹${widget.cottage.price} & Book Now",
